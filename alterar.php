...
<div class="conteudo_principal">
    ...
    <div class="bloco_1">
        <section>
            <h1 class="titulo">Alterar item <i class="fas fa-cogs"></i></h1>
        </section>
    </div>
    <div class="bloco_2">
        <div class="row">
                    ...
                    <div class="container card card_custom">
                        <div class="card-body">
                            ...
                            <form class="container form-group" action="" method="POST">
                                ...
                                <br>
                                <input class="btn submit_custom" id="alterar_item" type="button" value="Alterar item">
                            </form>
                        </div>
                    </div>
                </div>
...
<script src="scripts/alterar.js" type="text/javascript"></script>
